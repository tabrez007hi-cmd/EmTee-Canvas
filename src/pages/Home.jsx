    ...
    <div className="min-h-screen bg-slate-950 font-sans text-slate-200 selection:bg-indigo-500/30 overflow-x-hidden">
      ...
      <section className="relative pt-40 pb-20 md:pt-52 md:pb-32 px-6 flex flex-col items-center justify-center text-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto animate-fade-in">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-indigo-500/30 bg-indigo-500/10 text-indigo-300 text-xs font-bold uppercase tracking-widest mb-8 shadow-sm">
            <span className="w-2 h-2 rounded-full bg-indigo-400 animate-pulse"></span>
            The Next Generation HTML & Tailwind Builder
          </div>
          ...
          {/* ✨ Added more detailed hero copy */}
          <p className="text-lg md:text-xl text-slate-400 mb-12 leading-relaxed max-w-3xl mx-auto">
            EmTeeCanvas bridges the gap between design and development. Visually construct layouts, manipulate raw DOM trees, tweak deep CSS properties, and instantly export production-ready HTML code powered by Tailwind CSS. Built for freelancers, agencies, and creative developers.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            {user ? (
              ...
              <>
                <Link to="/authentication" className="w-full sm:w-auto px-10 py-4 bg-indigo-600 text-white font-bold rounded-full shadow-[0_0_30px_rgba(79,70,229,0.5)] hover:bg-indigo-500 hover:-translate-y-1 transition-all text-lg flex items-center justify-center gap-2">
                  <i className="bi bi-rocket-takeoff-fill"></i> Start Building Free
                </Link>
      ...
      <section id="features" className="py-24 bg-slate-900/50 border-y border-slate-800/50 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard icon="bi-bounding-box-circles" title="Visual Canvas Engine" desc="Click, interact, and inspect elements directly on a highly responsive sandbox viewport. Visual design has never felt this natural." />
            <FeatureCard icon="bi-palette-fill" title="Precision CSS Inspector" desc="Micro-manage flexbox, grids, typography, custom margins, and borders visually without writing a single line of CSS code." />
            <FeatureCard icon="bi-phone-flip" title="Dynamic Breakpoints" desc="Apply distinct, tailored styles across Desktop, Tablet, and Mobile views to guarantee flawless pixel-perfect layouts on any device." />
            <FeatureCard icon="bi-diagram-3" title="Live DOM Tree" desc="Retain full structural control. Duplicate, reorder, and meticulously manage parent-child relationships through the intuitive DOM view." />
            <FeatureCard icon="bi-layers-fill" title="Community Templates" desc="Stop starting from scratch. Kickstart your workspace by cloning stunning SaaS, Portfolio, and Dashboard templates built by the community." />
            <FeatureCard icon="bi-filetype-html" title="Raw Code & Overrides" desc="Need ultimate control? Dive directly into the integrated code editor to inject raw HTML or custom CSS styling into any node." />
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-12 h-12 rounded-xl bg-slate-800 flex items-center justify-center shrink-0 text-slate-300 text-xl shadow-inner"><i className="bi bi-person"></i></div>
                  <div>
                    <h4 className="text-white font-bold text-lg flex items-center gap-2">Normal Users</h4>
                ...
                <div className="flex gap-4">
                  <div className="w-12 h-12 rounded-xl bg-amber-500/20 flex items-center justify-center shrink-0 text-amber-500 text-xl border border-amber-500/30 shadow-[0_0_15px_rgba(251,191,36,0.2)]"><i className="bi bi-star-fill"></i></div>
                  <div>
                    <h4 className="text-amber-400 font-bold text-lg flex items-center gap-2">Pro Members <i className="bi bi-patch-check-fill text-amber-500 text-sm"></i></h4>
                ...
                <div className="flex gap-4">
                  <div className="w-12 h-12 rounded-xl bg-purple-500/20 flex items-center justify-center shrink-0 text-purple-400 text-xl border border-purple-500/30 shadow-[0_0_15px_rgba(168,85,247,0.2)]"><i className="bi bi-code-square"></i></div>
                  <div>
                    <h4 className="text-purple-400 font-bold text-lg flex items-center gap-2">Developers & Admins <i className="bi bi-shield-lock-fill text-purple-500 text-sm"></i></h4>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="bg-slate-950 border border-slate-800 rounded-2xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
            ...
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed relative z-10 font-medium">
              "Driven by a relentless passion for clean code and seamless digital creation, I built EmTeeCanvas to bridge the gap between imagination and reality. My vision was to create a sandbox where technical barriers vanish—where anyone can drag, drop, style, and generate complex HTML and Tailwind code without wrestling with local environments. Stop struggling with setup, and start engineering the future." 🚀
            </p>
            <div className="mt-8 flex items-center justify-center gap-4 text-slate-500">
               <span className="w-12 h-px bg-slate-700"></span>
               <span className="font-bold text-sm tracking-widest uppercase text-indigo-400">Founder & Lead Developer</span>
               <span className="w-12 h-px bg-slate-700"></span>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-slate-950 py-12 border-t border-slate-900 text-center relative z-10">
        <div className="flex items-center justify-center gap-3 mb-6">
          <div className="w-6 h-6 bg-indigo-600 rounded flex items-center justify-center shadow-[0_0_10px_rgba(79,70,229,0.5)]"><i className="bi bi-lightning-charge-fill text-white text-[10px]"></i></div>
