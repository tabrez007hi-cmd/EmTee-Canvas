...
export default function RoleBadge({ role, username = '', prefix = '' }) {
  ...
  const badges = {
    developer: (
      <svg className="w-4 h-4 text-purple-400 drop-shadow-[0_0_8px_rgba(168,85,247,0.8)] transition-transform hover:scale-110 shrink-0" fill="currentColor" viewBox="0 0 24 24" title="Developer">
